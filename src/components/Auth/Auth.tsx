		...
		<section className="bg-white px-4 md:px-10 py-10 md:py-20">
			...
			<div className="h-full w-full max-w-screen-lg mx-auto  overflow-hidden flex lg:flex-row flex-col justify-center gap-8 items-center">
				...
				<div className="w-full max-lg:max-w-lg lg:w-1/3">
					<h2 className="text-xl sm:text-2xl font-medium text-start mb-4 sm:mb-8">Already a Member?</h2>
					<Formik
				...
				<div className=" w-full max-lg:max-w-lg lg:w-2/3 border-t-2  max-lg:mt-4 pt-8 lg:border-l-2 border-neutral-200 lg:pl-8">
					<div className="text-xl sm:text-2xl font-medium mb-4 sm:mb-8">Registration Form</div>
					<Formik
						initialValues={{
							email: '',
							password: '',
					...
					>{({ handleChange, values, setFieldValue }) => (
						<Form>
							<div className="grid lg:grid-cols-2 grid-col-1 gap-4">
								...
								<button
									className="relative w-full h-12 flex items-center justify-center  rounded-md  font-medium text-neutral-950 focus-within:outline-none border border-neutral-200 overflow-hidden cursor-pointer "
								>
									<span className="w-full h-full flex justify-center text-sm items-center gap-2 bg-background">
										<MdCloudUpload size={18} className="min-w-5 w-5" />
